...
version: 1.0.0
description: Expert-level dark matter physics covering evidence, candidate particles, detection methods, structure formation, and alternative gravity theories.
author: luokai25
...
2. Detection method? (direct, indirect, collider)
...
Axions: ultralight 10^-5 eV, motivated by strong CP problem, cavity experiments.
...
MOND success: fits galaxy rotation curves with one parameter a0.
MOND failure: galaxy clusters require additional dark matter even with MOND.
TeVeS: relativistic MOND, difficulties with CMB and gravitational waves.
...
- Consider model-independent approaches where possible

## Common Pitfalls
| Pitfall | Fix |
|---|---|
| WIMP-centric view | Many viable candidates at different mass scales |
...
| Confusing exclusion limits and detection | Null result sets upper limit not ruled-out |
